 ...
 */
final class Version20220118131440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE model_version (id INT AUTO_INCREMENT NOT NULL, model_id INT NOT NULL, vehicle_mark_id INT NOT NULL, vehicle_range_id INT NOT NULL, name VARCHAR(255) NOT NULL, begin_at VARCHAR(255) NOT NULL, end_at VARCHAR(255) NOT NULL, year INT NOT NULL, motorisation VARCHAR(255) NOT NULL, cv_f INT NOT NULL, frame VARCHAR(255) NOT NULL, mark_name VARCHAR(255) NOT NULL, range_name VARCHAR(255) DEFAULT NULL, model_name VARCHAR(255) NOT NULL, INDEX IDX_DF8FBA327975B7E7 (model_id), INDEX IDX_DF8FBA325DE3AC44 (vehicle_mark_id), INDEX IDX_DF8FBA32F790DF25 (vehicle_range_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
